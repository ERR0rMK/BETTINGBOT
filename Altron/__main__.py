...
from Altron.modules import ALL_MODULES
from Altron.modules.helper_funcs.chat_status import is_user_admin
from Altron.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="💞 ᴀʙᴏᴜᴛ ᴍᴇ​​ 💞", callback_data="altron_"),
    ],
    [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Altron.modules." + module_name)
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="sᴏᴜʀᴄᴇ",
                            url="https://github.com/ERR0rMK/BETTINGBOT",
                        ),
                    ],
                    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="ᴅᴇᴠᴇʟᴏᴩᴇʀ", url="https://t.me/TheAltronX"
                        ),
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ", url="https://github.com/TheAltronX"
                        ),
                    ],
                    [
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                ...
                caption="ᴀʟᴛʀᴏɴ ✘ ʀᴏʙᴏᴛ ɪs ᴀʟɪᴠᴇ !\n\nᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ 𝐓ʜᴇ𝐀ʟᴛʀᴏɴ𝐗 🥀",
            )
        except Unauthorized:
            LOGGER.warning(
